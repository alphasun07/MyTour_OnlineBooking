                ...
                <div class="main-content col-lg-9 col-md-7 col-12">
                    <div class="d-flex justify-content-between mt-4">
                        <ol class="breadcrumb">
                            ...
                            @endforeach
                            <li class="breadcrumb-item active" aria-current="page" style="text-transform: capitalize;"><a href="">{{ !empty($post->category_id) ? (PcmDmsCategory::find($post->category_id))['name_'.config('app.locale')] : '' }}</a></li>
                        </ol>
