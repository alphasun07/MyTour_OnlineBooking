            ...
            <div class="d-flex flex-row">
                <div class="o-container__background--white x_panel">
                    ...
                    <dl class="o-dl__display--table">
                        ...
                        <dt class="o-dtDd__display--table-cell o-dt__width--8 text-left">Country</dt>
                        <dt class="o-dtDd__display--table-cell o-dt__width--8 text-left">City</dt>
                        <dt class="o-dtDd__display--table-cell o-dt__width--8 text-left">Address</dt>
